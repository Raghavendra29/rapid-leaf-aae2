...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rapid-leaf-aae2
```

A live public deployment of this template is available at [https://rapid-leaf-aae2.templates.workers.dev](https://rapid-leaf-aae2.templates.workers.dev)
